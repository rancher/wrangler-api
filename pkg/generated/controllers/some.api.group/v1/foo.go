...
import (
	...
	clientset "github.com/rancher/wrangler-api/pkg/generated/clientset/versioned/typed/some.api.group/v1"
	informers "github.com/rancher/wrangler-api/pkg/generated/informers/externalversions/some.api.group/v1"
	listers "github.com/rancher/wrangler-api/pkg/generated/listers/some.api.group/v1"
...
func UpdateFooOnChange(updater generic.Updater, handler FooHandler) FooHandler {
	return func(key string, obj *v1.Foo) (*v1.Foo, error) {
		if obj == nil {
