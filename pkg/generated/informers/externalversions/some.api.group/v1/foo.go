...
import (
	...
	someapigroupv1 "github.com/rancher/wrangler-api/pkg/apis/some.api.group/v1"
	...
	v1 "github.com/rancher/wrangler-api/pkg/generated/listers/some.api.group/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SomeV1().Foos(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SomeV1().Foos(namespace).Watch(options)
			},
		},
		&someapigroupv1.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&someapigroupv1.Foo{}, f.defaultInformer)
}
