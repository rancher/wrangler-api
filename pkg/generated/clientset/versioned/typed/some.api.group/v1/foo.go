...
type FooInterface interface {
	...
	Get(name string, options metav1.GetOptions) (*v1.Foo, error)
	List(opts metav1.ListOptions) (*v1.FooList, error)
	Watch(opts metav1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.Foo, err error)
	FooExpansion
}
...
func newFoos(c *SomeV1Client, namespace string) *foos {
	return &foos{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *foos) Get(name string, options metav1.GetOptions) (result *v1.Foo, err error) {
	result = &v1.Foo{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) List(opts metav1.ListOptions) (result *v1.FooList, err error) {
...
func (c *foos) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *foos) Create(foo *v1.Foo) (result *v1.Foo, err error) {
	result = &v1.Foo{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Update(foo *v1.Foo) (result *v1.Foo, err error) {
	result = &v1.Foo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("foos").
...
func (c *foos) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *foos) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *foos) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.Foo, err error) {
	result = &v1.Foo{}
