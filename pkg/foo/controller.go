...
import (
	"context"
	v1 "github.com/rancher/wrangler-api/pkg/apis/some.api.group/v1"
	foocontroller "github.com/rancher/wrangler-api/pkg/generated/controllers/some.api.group/v1"
)
